        ...
        <div className="card border-0">
            ...
            <div className="col-md-6">
              <div className="card-body text-start">
                ...
                <p className="mb-3">
                  ...
                  across India with your loved ones, and you’re starting this
                  incredible journey by bus. It’s indeed an amazing experience
                  that everyone desires. And why not? There’s something truly
                  intriguing about setting off on a road trip. Imagine yourself
                  settled, capturing awe-inspiring scenes, lush greenery,
                  vibrant cities, and rustic villages from the window seat. From
                  wholesome conversations with loved ones to exploring unplanned
                  stops, you can experience it during your mesmerising journey.
                  Whether you’re travelling with your partner, family members,
                  friends, or solo, the road to your favourite destination turns
                  into a beautiful canvas for unforgettable memories that one
                  cherishes. In addition to this, the easy booking online,
                  comfortable seating, spacious coaches, and vast route coverage
                  are some other features, promising a convenient journey at its
                  peak. So, why wait? Book your bus now and start your trip
                  packed with lots of exploration and experiences.
                </p>
              </div>
            </div>
          ...
          <div>
            <div className="card-body text-start pt-0">
              <p className="mb-0">
                So, why wait? Book your bus now and start your trip packed with
                lots of exploration and experiences. In addition to this, the
                easy booking online, comfortable seating, spacious coaches, and
                vast route coverage are some other features, promising a
                convenient journey at its peak. So, why wait? Book your bus now
                and start your trip packed with lots of exploration and
                experiences.
              </p>
            </div>
          </div>
